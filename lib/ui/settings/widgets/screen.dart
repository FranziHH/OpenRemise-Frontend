...
class _SettingsScreenState extends ConsumerState<SettingsScreen> {
  static const List<double> _currentLimits = [0.5, 1.3, 2.7, 4.1];
  static const List<int> _dccBiDiDurations = [0, 57, 58, 59, 60, 61];
  static const List<String> _dccProgrammingTypes = [
    'Nothing',
    'Bit only',
    'Byte only',
    'Bit and byte',
  ...
  final Map<String, ExpansionTileController> _expansionTileControllers = {
    ...
    'HTTP': ExpansionTileController(),
    'Current': ExpansionTileController(),
    'LED': ExpansionTileController(),
    'DCC': ExpansionTileController(),
    'Locos': ExpansionTileController(),
    'Accessories': ExpansionTileController(),
    'Extensions': ExpansionTileController(),
  };
              ...
              actions: [
                IconButton(
                  onPressed: () {
                    for (final c in _expansionTileControllers.values) {
                      _isExpanded ? c.collapse() : c.expand();
                    }
                    setState(() => _isExpanded = !_isExpanded);
                  },
                  tooltip: _isExpanded ? 'Collapse all' : 'Expand all',
                  icon: Icon(
                ...
                IconButton(
                  onPressed: () {
                    ...
                    json['dcc_bidibit_dur'] = _dccBiDiDurations
                ...
                child: ListView(
                  ...
                  children: [
                    SettingsTile(
                      ...
                      controller: _expansionTileControllers['Network'],
                      children: [
                        Tooltip(
                          message:
                    ...
                    SettingsTile(
                      ...
                      controller: _expansionTileControllers['HTTP'],
                      children: [
                        Tooltip(
                          message:
                    ...
                    SettingsTile(
                      ...
                      controller: _expansionTileControllers['Current'],
                      children: [
                        Tooltip(
                          ...
                          child: FormBuilderSlider(
                            ...
                            valueWidget: (value) => Text(
                              _currentLimits[int.parse(value)].toString(),
                            ),
                          ),
                        ),
                        Tooltip(
                    ...
                    SettingsTile(
                      ...
                      controller: _expansionTileControllers['LED'],
                      children: [
                        Tooltip(
                    ...
                    SettingsTile(
                      ...
                      controller: _expansionTileControllers['DCC'],
                      children: [
                        Tooltip(
                        ...
                        Tooltip(
                          ...
                          child: FormBuilderSlider(
                            ...
                            initialValue: _dccBiDiDurations
                            ...
                            valueTransformer: (value) =>
                                _dccBiDiDurations[value!.toInt()],
                            min: 0,
                            max: 61 - 57 + 1,
                            divisions: 61 - 57 + 1,
                            displayValues: DisplayValues.current,
                            valueWidget: (value) => Text(
                              _dccBiDiDurations[int.parse(value)].toString(),
                            ),
                          ),
                        ),
                        Tooltip(
                          ...
                          child: FormBuilderSlider(
                            ...
                            displayValues: DisplayValues.current,
                            valueWidget: (value) =>
                                Text(_dccProgrammingTypes[int.parse(value)]),
                          ),
                        ),
                        Tooltip(
                          message:
                    ...
                    SettingsTile(
                      ...
                      controller: _expansionTileControllers['Locos'],
                      children: [
                        FormBuilderCheckboxGroup(
                          name: 'dcc_loco_flags',
                          initialValue: [
                    ...
                    SettingsTile(
                      ...
                      controller: _expansionTileControllers['Accessories'],
                      children: [
                        Tooltip(
                    ...
                    SettingsTile(
                      ...
                      controller: _expansionTileControllers['Extensions'],
                      children: [
                        FormBuilderCheckboxGroup(
                          name: 'ext_flags',
                          initialValue: [
